#!/usr/bin/env python3
"""Enrich pick_diverse_bottles subtask language with phase-wise variants."""
...
PHASE_VARIANTS = {
    0: [
        ...
        "Move into position around the two bottles.",
        "Reach toward the bottles.",
        "Position the grippers near the bottle bodies.",
        "Navigate both arms toward the bottles.",
        "Move closer to the brown bottle and the white bottle.",
        "Approach the two different bottles and prepare to grasp them.",
    ],
    1: [
        "Grasp both bottles.",
        "Close both grippers.",
        "Pick up the two bottles.",
        "Secure each bottle with a gripper.",
        "Clamp onto the bottles.",
        "Take hold of both bottles.",
        "Grip the bottles firmly.",
        "Close the fingers around the two bottles.",
        "Hold the brown bottle and the white bottle.",
    ...
    2: [
        ...
        "Carry the brown bottle and the white bottle toward the center together.",
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Enrich pick_diverse_bottles subtask language templates.")

#!/usr/bin/env python3
"""Enrich place_a2b_right subtask language with generic phase-wise variants."""
...
PHASE_VARIANTS = {
    ...
    1: [
        ...
        "Complete the grasp so the object can be moved to the right side.",
    ],
    2: [
        "Move the object to the right side of the reference object.",
        "Carry it right of the other object.",
        "Transport the held object toward the right side.",
        "Move the grasped object beside the reference item.",
        "Bring the object to the right of the object that stays on the table.",
        "Guide the object into position on the right side.",
        "Shift the movable item to the right of the reference object.",
        "Move the object while aligning it with the right side of the stationary item.",
        "Carry the object and place it near the right edge of the reference object.",
        "Transfer the held object to the target position right of the remaining table object.",
    ],
    3: [
        "Place the object to the right of the reference object.",
        "Release the object.",
        "Open the gripper to set it down.",
        "Put the object beside the reference item.",
        "Let go of the object on the right side.",
        "Set it down.",
        "Drop the object gently at the target position.",
        "Finish placing the object to the right.",
        "Open the fingers and leave the object beside the other item.",
        "Complete the task by placing the movable object to the right of the reference object.",
    ],
}
...
DEFAULT_INSTRUCTION = "Place the movable object to the right of the reference object."
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Enrich place_a2b_right subtask language templates.")

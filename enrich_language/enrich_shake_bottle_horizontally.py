#!/usr/bin/env python3
"""Enrich shake_bottle_horizontally subtask language with phase-wise variants."""
...
PHASE_VARIANTS = {
    0: [
        ...
        "Approach the bottle and prepare to grasp it for horizontal shaking.",
    ],
    1: [
        "Grasp the bottle.",
        "Close the gripper.",
        ...
        "Complete the grasp so the bottle can be lifted and turned sideways.",
    ],
    2: [
        "Move and orient the bottle horizontally.",
        "Lift the bottle sideways.",
        "Raise the bottle and turn it horizontal.",
        "Move the grasped bottle into a horizontal pose.",
        "Bring the bottle up and align it sideways.",
        "Lift and level the bottle before shaking.",
        "Move the bottle into a side-facing position.",
        "Raise the bottle while adjusting it for horizontal shaking.",
        "Orient the bottle sideways while keeping it secured in the gripper.",
        "Lift the bottle to a stable horizontal pose for the shaking motion.",
    ],
    3: [
        "Shake the bottle horizontally.",
        "Shake it side to side.",
        "Move the bottle left and right.",
        "Gently shake the bottle sideways.",
        "Oscillate the bottle horizontally.",
        "Shake the held bottle in a horizontal motion.",
        "Move the bottle back and forth across the horizontal direction.",
        "Give the bottle a controlled side-to-side shake.",
        "Shake the raised bottle horizontally while keeping it firmly grasped.",
        "Complete the task by lifting the bottle and shaking it from side to side.",
    ],
}
...
DEFAULT_INSTRUCTION = "Shake the bottle horizontally."
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Enrich shake_bottle_horizontally subtask language templates."
    )

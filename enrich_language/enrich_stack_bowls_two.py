#!/usr/bin/env python3
"""Enrich stack_bowls_two subtask language with phase-wise variants."""
...
PHASE_VARIANTS = {
    0: [
        ...
        "Approach the first bowl and prepare to place it as the bottom bowl.",
    ],
    1: [
    ...
    4: [
        ...
        "Navigate to the bowl that will be stacked on top.",
    ...
    6: [
        ...
        "Move the second bowl to the top of the stack.",
    ...
    7: [
        ...
        "Let go of the second bowl on top of the stack.",
        ...
        "Open the fingers and leave the second bowl as the top layer.",
        "Complete the stack by placing the second bowl on top of the first bowl.",
    ],
}
...
DEFAULT_INSTRUCTION = "Stack two bowls."
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Enrich stack_bowls_two subtask language templates.")

#!/usr/bin/env python3
"""Plot one blocks_ranking_size episode with predicted phase boundaries."""
...
from task_def.blocks_ranking_size import BlocksRankingSizeProcessor
...
def analyze_episode(
    ...
    with h5py.File(hdf5_path, "r") as f:
        ...
        arm_sequence = list(task_processor.current_arm_sequence)
    ...
    fig.suptitle(f"{TASK_NAME} trajectory analysis ({hdf5_path.parent.name}, arms={arms_text})", fontweight="bold")
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Analyze one blocks_ranking_size trajectory.")

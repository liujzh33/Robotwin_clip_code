#!/usr/bin/env python3
"""Plot one click_bell episode with predicted phase boundaries."""
...
from task_def.click_bell import ClickBellProcessor
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Analyze one click_bell trajectory.")

#!/usr/bin/env python3
"""Plot one grab_roller episode with predicted phase boundaries."""
...
from task_def.grab_roller import GrabRollerProcessor
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Analyze one grab_roller trajectory.")

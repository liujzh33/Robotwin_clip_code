#!/usr/bin/env python3
"""Plot one handover_block episode with predicted phase boundaries."""
...
from task_def.handover_block import HandoverBlockProcessor
...
def analyze_episode(
    ...
    labels = ["L Approach", "L Grasp", "L Move Center", "R Approach", "R Grasp", "R Move Pad", "R Place"]
    colors = ["#ffcccc", "#ffd9cc", "#ffe6cc", "#ccffcc", "#d9ffcc", "#e6ffcc", "#ccccff"]
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Analyze one handover_block trajectory.")

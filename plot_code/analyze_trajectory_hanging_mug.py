#!/usr/bin/env python3
"""Plot one hanging_mug episode with predicted phase boundaries."""
...
from task_def.hanging_mug import HangingMugProcessor
...
def analyze_episode(
    ...
    colors = ["#ffcccc", "#ffd9cc", "#ffe6cc", "#fff0cc", "#ccffcc", "#d9ffcc", "#ccccff"]
    ...
    checkpoint_names = ["c0", "c1", "c2", "c3", "c4", "c5"]
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Analyze one hanging_mug trajectory.")

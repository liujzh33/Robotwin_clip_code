#!/usr/bin/env python3
"""Plot one move_can_pot episode with predicted phase boundaries."""
...
from task_def.move_can_pot import MoveCanPotProcessor
...
def analyze_episode(
    ...
    task_processor = MoveCanPotProcessor()
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Analyze one move_can_pot trajectory.")

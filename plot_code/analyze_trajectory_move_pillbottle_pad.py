#!/usr/bin/env python3
"""Plot one move_pillbottle_pad episode with predicted phase boundaries."""
...
from task_def.move_pillbottle_pad import MovePillbottlePadProcessor
...
def analyze_episode(
    ...
    task_processor = MovePillbottlePadProcessor()
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Analyze one move_pillbottle_pad trajectory.")

#!/usr/bin/env python3
"""Plot one move_playingcard_away episode with predicted phase boundaries."""
...
from task_def.move_playingcard_away import MovePlayingcardAwayProcessor
...
def analyze_episode(
    ...
    task_processor = MovePlayingcardAwayProcessor()
    ...
    labels = ["Approach", "Grasp", "Move Out", "Place"]
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Analyze one move_playingcard_away trajectory.")

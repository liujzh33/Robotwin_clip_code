#!/usr/bin/env python3
"""Plot one move_stapler_pad episode with predicted phase boundaries."""
...
from task_def.move_stapler_pad import MoveStaplerPadProcessor
...
def analyze_episode(
    ...
    task_processor = MoveStaplerPadProcessor()
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Analyze one move_stapler_pad trajectory.")

#!/usr/bin/env python3
"""Plot one open_laptop episode with predicted phase boundaries."""
...
from task_def.open_laptop import OpenLaptopProcessor
...
def analyze_episode(
    ...
    task_processor = OpenLaptopProcessor()
    ...
    labels = ["Approach", "Grasp", "Open Lid"]
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Analyze one open_laptop trajectory.")

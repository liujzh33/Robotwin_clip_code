#!/usr/bin/env python3
"""Plot one open_microwave episode with predicted phase boundaries."""
...
from task_def.open_microwave import OpenMicrowaveProcessor
...
def analyze_episode(
    ...
    task_processor = OpenMicrowaveProcessor()
    ...
    labels = ["Approach", "Grasp", "Pull Door"]
    colors = ["#ffcccc", "#ffd9cc", "#ccffcc"]
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Analyze one open_microwave trajectory.")

#!/usr/bin/env python3
"""Plot one pick_diverse_bottles episode with predicted phase boundaries."""
...
from task_def.pick_diverse_bottles import PickDiverseBottlesProcessor
...
def analyze_episode(
    ...
    task_processor = PickDiverseBottlesProcessor()
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Analyze one pick_diverse_bottles trajectory.")

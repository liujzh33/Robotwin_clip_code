#!/usr/bin/env python3
"""Plot one pick_dual_bottles episode with predicted phase boundaries."""
...
from task_def.pick_dual_bottles import PickDualBottlesProcessor
...
def analyze_episode(
    ...
    task_processor = PickDualBottlesProcessor()
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Analyze one pick_dual_bottles trajectory.")

#!/usr/bin/env python3
"""Plot one place_a2b_left episode with predicted phase boundaries."""
...
from task_def.place_a2b_left import PlaceA2BLeftProcessor
...
def analyze_episode(
    ...
    task_processor = PlaceA2BLeftProcessor()
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Analyze one place_a2b_left trajectory.")

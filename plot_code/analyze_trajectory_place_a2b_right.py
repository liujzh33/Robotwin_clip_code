#!/usr/bin/env python3
"""Plot one place_a2b_right episode with predicted phase boundaries."""
...
from task_def.place_a2b_right import PlaceA2BRightProcessor
...
def analyze_episode(
    ...
    task_processor = PlaceA2BRightProcessor()
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Analyze one place_a2b_right trajectory.")

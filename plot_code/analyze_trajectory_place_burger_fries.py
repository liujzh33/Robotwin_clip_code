#!/usr/bin/env python3
"""Plot one place_burger_fries episode with predicted phase boundaries."""
...
from task_def.place_burger_fries import PlaceBurgerFriesProcessor
...
def analyze_episode(
    ...
    task_processor = PlaceBurgerFriesProcessor()
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Analyze one place_burger_fries trajectory.")

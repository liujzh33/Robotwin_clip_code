#!/usr/bin/env python3
"""Plot one place_cans_plasticbox episode with predicted phase boundaries."""
...
from task_def.place_cans_plasticbox import PlaceCansPlasticboxProcessor
...
def analyze_episode(
    ...
    task_processor = PlaceCansPlasticboxProcessor()
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Analyze one place_cans_plasticbox trajectory.")

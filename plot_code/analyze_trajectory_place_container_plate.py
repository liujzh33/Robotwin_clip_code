#!/usr/bin/env python3
"""Plot one place_container_plate episode with predicted phase boundaries."""
...
from task_def.place_container_plate import PlaceContainerPlateProcessor
...
def analyze_episode(
    ...
    task_processor = PlaceContainerPlateProcessor()
    ...
    labels = ["Approach", "Grasp", "Move", "Release"]
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Analyze one place_container_plate trajectory.")

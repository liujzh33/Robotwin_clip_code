#!/usr/bin/env python3
"""Plot one place_empty_cup episode with predicted phase boundaries."""
...
from task_def.place_empty_cup import PlaceEmptyCupProcessor
...
def analyze_episode(
    ...
    task_processor = PlaceEmptyCupProcessor()
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Analyze one place_empty_cup trajectory.")

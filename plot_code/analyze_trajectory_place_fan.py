#!/usr/bin/env python3
"""Plot one place_fan episode with predicted phase boundaries."""
...
from task_def.place_fan import PlaceFanProcessor
...
def analyze_episode(
    ...
    task_processor = PlaceFanProcessor()
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Analyze one place_fan trajectory.")

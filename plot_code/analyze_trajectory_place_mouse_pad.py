#!/usr/bin/env python3
"""Plot one place_mouse_pad episode with predicted phase boundaries."""
...
from task_def.place_mouse_pad import PlaceMousePadProcessor
...
def analyze_episode(
    ...
    task_processor = PlaceMousePadProcessor()
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Analyze one place_mouse_pad trajectory.")

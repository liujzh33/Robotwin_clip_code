#!/usr/bin/env python3
"""Plot one place_object_stand episode with predicted phase boundaries."""
...
from task_def.place_object_stand import PlaceObjectStandProcessor
...
def analyze_episode(
    ...
    task_processor = PlaceObjectStandProcessor()
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Analyze one place_object_stand trajectory.")

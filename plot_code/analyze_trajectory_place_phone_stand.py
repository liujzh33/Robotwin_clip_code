#!/usr/bin/env python3
"""Plot one place_phone_stand episode with predicted phase boundaries."""
...
from task_def.place_phone_stand import PlacePhoneStandProcessor
...
def analyze_episode(
    ...
    task_processor = PlacePhoneStandProcessor()
    ...
    labels = ["Approach", "Grasp", "Move+Orient", "Place"]
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Analyze one place_phone_stand trajectory.")

#!/usr/bin/env python3
"""Plot one place_shoe episode with predicted phase boundaries."""
...
from task_def.place_shoe import PlaceShoeProcessor
...
def analyze_episode(
    ...
    task_processor = PlaceShoeProcessor()
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Analyze one place_shoe trajectory.")

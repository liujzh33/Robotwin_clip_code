#!/usr/bin/env python3
"""Plot one press_stapler episode with predicted phase boundaries."""
...
from task_def.press_stapler import PressStaplerProcessor
...
def analyze_episode(
    ...
    task_processor = PressStaplerProcessor()
    ...
    axes[2].axhline(
        y=task_processor.joint_velocity_threshold,
        color="r",
        linestyle="--",
        alpha=0.5,
    ...
    labels = ["Approach", "Close Gripper", "Press Down"]
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Analyze one press_stapler trajectory.")

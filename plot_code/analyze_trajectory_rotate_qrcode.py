#!/usr/bin/env python3
"""Plot one rotate_qrcode episode with predicted phase boundaries."""
...
from task_def.rotate_qrcode import RotateQrcodeProcessor
...
def analyze_episode(
    ...
    task_processor = RotateQrcodeProcessor()
    ...
    labels = ["Approach", "Grasp", "Rotate", "Place"]
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Analyze one rotate_qrcode trajectory.")

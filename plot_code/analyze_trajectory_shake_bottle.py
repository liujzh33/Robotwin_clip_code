#!/usr/bin/env python3
"""Plot one shake_bottle episode with predicted phase boundaries."""
...
from task_def.shake_bottle import ShakeBottleProcessor
...
def analyze_episode(
    ...
    task_processor = ShakeBottleProcessor()
    ...
    labels = ["Approach", "Grasp", "Lift", "Shake"]
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Analyze one shake_bottle trajectory.")

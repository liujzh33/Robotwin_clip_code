#!/usr/bin/env python3
"""Plot one stack_blocks_three episode with predicted phase boundaries."""
...
from task_def.stack_blocks_three import StackBlocksThreeProcessor
...
def analyze_episode(
    ...
    task_processor = StackBlocksThreeProcessor()
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Analyze one stack_blocks_three trajectory.")

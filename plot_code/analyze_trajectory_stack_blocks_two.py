#!/usr/bin/env python3
"""Plot one stack_blocks_two episode with predicted phase boundaries."""
...
from task_def.stack_blocks_two import StackBlocksTwoProcessor
...
def analyze_episode(
    ...
    task_processor = StackBlocksTwoProcessor()
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Analyze one stack_blocks_two trajectory.")

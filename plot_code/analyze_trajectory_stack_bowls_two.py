#!/usr/bin/env python3
"""Plot one stack_bowls_two episode with predicted phase boundaries."""
...
from task_def.stack_bowls_two import StackBowlsTwoProcessor
...
def analyze_episode(
    ...
    task_processor = StackBowlsTwoProcessor()
    ...
    checkpoint_labels = ["A1", "B1", "C1", "D1", "A2", "B2", "C2"]
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Analyze one stack_bowls_two trajectory.")

#!/usr/bin/env python3
"""Plot one stamp_seal episode with predicted phase boundaries."""
...
from task_def.stamp_seal import StampSealProcessor
...
def analyze_episode(
    ...
    task_processor = StampSealProcessor()
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Analyze one stamp_seal trajectory.")

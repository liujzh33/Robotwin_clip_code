#!/usr/bin/env python3
"""Batch plot adjust_bottle trajectory analyses."""
...
ANALYZE_SCRIPT = Path(__file__).resolve().parent / "analyze_trajectory_adjust_bottle.py"
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Batch analyze adjust_bottle trajectories.")
    ...
    parser.add_argument("--raw_root", default=None, help="Optional raw dataset root containing adjust_bottle/setting/data")

#!/usr/bin/env python3
"""Batch plot beat_block_hammer trajectory analyses."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Batch analyze beat_block_hammer trajectories.")
    ...
    parser.add_argument("--raw_root", default=None, help="Optional raw dataset root containing beat_block_hammer/setting/data")

#!/usr/bin/env python3
"""Batch plot blocks_ranking_rgb trajectory analyses."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Batch analyze blocks_ranking_rgb trajectories.")
    ...
    parser.add_argument("--raw_root", default=None, help="Optional raw dataset root containing blocks_ranking_rgb/setting/data")

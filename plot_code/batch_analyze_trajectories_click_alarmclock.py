#!/usr/bin/env python3
"""Batch plot click_alarmclock trajectory analyses."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Batch analyze click_alarmclock trajectories.")
    ...
    parser.add_argument("--raw_root", default=None, help="Optional raw dataset root containing click_alarmclock/setting/data")

#!/usr/bin/env python3
"""Batch plot click_bell trajectory analyses."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Batch analyze click_bell trajectories.")
    ...
    parser.add_argument("--raw_root", default=None, help="Optional raw dataset root containing click_bell/setting/data")

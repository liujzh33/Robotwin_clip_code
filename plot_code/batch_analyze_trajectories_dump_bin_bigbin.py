#!/usr/bin/env python3
"""Batch plot dump_bin_bigbin trajectory analyses."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Batch analyze dump_bin_bigbin trajectories.")
    ...
    parser.add_argument("--raw_root", default=None, help="Optional raw dataset root containing dump_bin_bigbin/setting/data")

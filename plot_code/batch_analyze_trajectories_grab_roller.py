#!/usr/bin/env python3
"""Batch plot grab_roller trajectory analyses."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Batch analyze grab_roller trajectories.")
    ...
    parser.add_argument("--raw_root", default=None, help="Optional raw dataset root containing grab_roller/setting/data")

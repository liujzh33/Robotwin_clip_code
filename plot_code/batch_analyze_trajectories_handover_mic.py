#!/usr/bin/env python3
"""Batch plot handover_mic trajectory analyses."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Batch analyze handover_mic trajectories.")
    ...
    parser.add_argument("--raw_root", default=None, help="Optional raw dataset root containing handover_mic/setting/data")

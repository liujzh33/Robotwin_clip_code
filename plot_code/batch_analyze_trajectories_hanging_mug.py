#!/usr/bin/env python3
"""Batch plot hanging_mug trajectory analyses."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Batch analyze hanging_mug trajectories.")
    ...
    parser.add_argument("--raw_root", default=None, help="Optional raw dataset root containing hanging_mug/setting/data")

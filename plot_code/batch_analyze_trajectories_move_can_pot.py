#!/usr/bin/env python3
"""Batch plot move_can_pot trajectory analyses."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Batch analyze move_can_pot trajectories.")
    ...
    parser.add_argument("--raw_root", default=None, help="Optional raw dataset root containing move_can_pot/setting/data")

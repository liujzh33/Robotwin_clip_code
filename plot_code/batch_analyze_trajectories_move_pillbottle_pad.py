#!/usr/bin/env python3
"""Batch plot move_pillbottle_pad trajectory analyses."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Batch analyze move_pillbottle_pad trajectories.")
    ...
    parser.add_argument("--raw_root", default=None, help="Optional raw dataset root containing move_pillbottle_pad/setting/data")

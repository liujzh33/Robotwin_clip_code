#!/usr/bin/env python3
"""Batch plot move_stapler_pad trajectory analyses."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Batch analyze move_stapler_pad trajectories.")
    ...
    parser.add_argument("--raw_root", default=None, help="Optional raw dataset root containing move_stapler_pad/setting/data")

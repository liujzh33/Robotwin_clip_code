#!/usr/bin/env python3
"""Batch plot open_laptop trajectory analyses."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Batch analyze open_laptop trajectories.")
    ...
    parser.add_argument("--raw_root", default=None, help="Optional raw dataset root containing open_laptop/setting/data")

#!/usr/bin/env python3
"""Batch plot pick_dual_bottles trajectory analyses."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Batch analyze pick_dual_bottles trajectories.")
    ...
    parser.add_argument("--raw_root", default=None, help="Optional raw dataset root containing pick_dual_bottles/setting/data")

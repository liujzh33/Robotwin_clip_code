#!/usr/bin/env python3
"""Batch plot place_a2b_right trajectory analyses."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Batch analyze place_a2b_right trajectories.")
    ...
    parser.add_argument("--raw_root", default=None, help="Optional raw dataset root containing place_a2b_right/setting/data")

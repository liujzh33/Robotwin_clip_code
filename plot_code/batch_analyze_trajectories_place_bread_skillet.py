#!/usr/bin/env python3
"""Batch plot place_bread_skillet trajectory analyses."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Batch analyze place_bread_skillet trajectories.")
    ...
    parser.add_argument("--raw_root", default=None, help="Optional raw dataset root containing place_bread_skillet/setting/data")

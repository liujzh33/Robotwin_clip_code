#!/usr/bin/env python3
"""Batch plot place_burger_fries trajectory analyses."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Batch analyze place_burger_fries trajectories.")
    ...
    parser.add_argument("--raw_root", default=None, help="Optional raw dataset root containing place_burger_fries/setting/data")

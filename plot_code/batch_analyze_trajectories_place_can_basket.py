#!/usr/bin/env python3
"""Batch plot place_can_basket trajectory analyses."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Batch analyze place_can_basket trajectories.")
    ...
    parser.add_argument("--raw_root", default=None, help="Optional raw dataset root containing place_can_basket/setting/data")

#!/usr/bin/env python3
"""Batch plot place_cans_plasticbox trajectory analyses."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Batch analyze place_cans_plasticbox trajectories.")
    ...
    parser.add_argument("--raw_root", default=None, help="Optional raw dataset root containing place_cans_plasticbox/setting/data")

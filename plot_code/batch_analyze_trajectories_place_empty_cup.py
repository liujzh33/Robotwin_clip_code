#!/usr/bin/env python3
"""Batch plot place_empty_cup trajectory analyses."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Batch analyze place_empty_cup trajectories.")
    ...
    parser.add_argument("--raw_root", default=None, help="Optional raw dataset root containing place_empty_cup/setting/data")

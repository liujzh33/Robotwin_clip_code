#!/usr/bin/env python3
"""Batch plot place_mouse_pad trajectory analyses."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Batch analyze place_mouse_pad trajectories.")
    ...
    parser.add_argument("--raw_root", default=None, help="Optional raw dataset root containing place_mouse_pad/setting/data")

#!/usr/bin/env python3
"""Batch plot place_object_scale trajectory analyses."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Batch analyze place_object_scale trajectories.")
    ...
    parser.add_argument("--raw_root", default=None, help="Optional raw dataset root containing place_object_scale/setting/data")

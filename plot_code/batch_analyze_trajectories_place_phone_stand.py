#!/usr/bin/env python3
"""Batch plot place_phone_stand trajectory analyses."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Batch analyze place_phone_stand trajectories.")
    ...
    parser.add_argument("--raw_root", default=None, help="Optional raw dataset root containing place_phone_stand/setting/data")

#!/usr/bin/env python3
"""Batch plot place_shoe trajectory analyses."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Batch analyze place_shoe trajectories.")
    ...
    parser.add_argument("--raw_root", default=None, help="Optional raw dataset root containing place_shoe/setting/data")

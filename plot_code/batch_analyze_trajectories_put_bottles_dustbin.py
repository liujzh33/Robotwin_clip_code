#!/usr/bin/env python3
"""Batch plot put_bottles_dustbin trajectory analyses."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Batch analyze put_bottles_dustbin trajectories.")
    ...
    parser.add_argument("--raw_root", default=None, help="Optional raw dataset root containing put_bottles_dustbin/setting/data")

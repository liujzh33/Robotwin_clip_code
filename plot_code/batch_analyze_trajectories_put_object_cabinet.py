#!/usr/bin/env python3
"""Batch plot put_object_cabinet trajectory analyses."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Batch analyze put_object_cabinet trajectories.")
    ...
    parser.add_argument("--raw_root", default=None, help="Optional raw dataset root containing put_object_cabinet/setting/data")

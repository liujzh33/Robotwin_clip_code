#!/usr/bin/env python3
"""Batch plot rotate_qrcode trajectory analyses."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Batch analyze rotate_qrcode trajectories.")
    ...
    parser.add_argument("--raw_root", default=None, help="Optional raw dataset root containing rotate_qrcode/setting/data")

#!/usr/bin/env python3
"""Batch plot scan_object trajectory analyses."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Batch analyze scan_object trajectories.")
    ...
    parser.add_argument("--raw_root", default=None, help="Optional raw dataset root containing scan_object/setting/data")

#!/usr/bin/env python3
"""Batch plot shake_bottle_horizontally trajectory analyses."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Batch analyze shake_bottle_horizontally trajectories.")
    ...
    parser.add_argument(
        "--raw_root",
        default=None,
        help="Optional raw dataset root containing shake_bottle_horizontally/setting/data",
    )

#!/usr/bin/env python3
"""Batch plot stack_bowls_three trajectory analyses."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Batch analyze stack_bowls_three trajectories.")
    ...
    parser.add_argument(
        "--raw_root",
        default=None,
        help="Optional raw dataset root containing stack_bowls_three/setting/data",
    )

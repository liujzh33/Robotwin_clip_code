#!/usr/bin/env python3
"""Batch plot stamp_seal trajectory analyses."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Batch analyze stamp_seal trajectories.")
    ...
    parser.add_argument("--raw_root", default=None, help="Optional raw dataset root containing stamp_seal/setting/data")

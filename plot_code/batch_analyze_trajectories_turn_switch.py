#!/usr/bin/env python3
"""Batch plot turn_switch trajectory analyses."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Batch analyze turn_switch trajectories.")
    ...
    parser.add_argument("--raw_root", default=None, help="Optional raw dataset root containing turn_switch/setting/data")

"""Rule-based phase segmentation for the move_playingcard_away task.

Single-object pick, move outward, and place. Active arm is inferred from the first
...
class MovePlayingcardAwayProcessor(BaseTaskProcessor):
    """Four-phase splitter: approach, grasp, move outward, place."""
    ...
    def get_subtask_descriptions(self) -> list[str]:
        return [
            ...
            "Place the playing card case away from the table.",
        ]

"""Rule-based phase segmentation for the move_stapler_pad task.

Standard single-object pick-and-place onto a gray mat. The active arm is inferred
...
class MoveStaplerPadProcessor(BaseTaskProcessor):
    ...
    def get_subtask_descriptions(self) -> list[str]:
        return [
            ...
            "Grasp the stapler.",
            "Move the stapler above the gray mat while keeping its pose stable.",

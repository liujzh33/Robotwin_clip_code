"""Rule-based phase segmentation for the place_a2b_left task.

Pick movable object A and place it to the left of reference object B on the table.
...
class PlaceA2BLeftProcessor(BaseTaskProcessor):

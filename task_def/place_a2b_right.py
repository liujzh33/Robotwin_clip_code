"""Rule-based phase segmentation for the place_a2b_right task.

Pick movable object A and place it to the right of reference object B on the table.
...
class PlaceA2BRightProcessor(BaseTaskProcessor):
